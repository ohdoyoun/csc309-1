NavigationModel = function(){
	...
	self.logout = function(){
		self.changeCurrentNavigationType(1);
	};
	...
	self.navigation = {
		Account: {
			...
			"Wallet":{content:"wallets/index", setupCallback:self.emptySetup},
		...
		Communities: {
			navNum:0,
			"Community List":{content:"community/index", setupCallback:self.emptySetup},
			"Search for Communities":{content:"Communities/ActiveCommunities", setupCallback:self.emptySetup},
			"Create your Community":{content:"Communities/ActiveCommunities", setupCallback:self.emptySetup}
		},
		ProjectDetails:{
			navNum:2,
		...
		Logout:{
			navNum:0,
			"Logout":{content:"users/logout", setupCallback:self.logout, hidden:true}			
		},
		Login:{
			navNum:1,
