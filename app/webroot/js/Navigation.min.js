NavigationModel = function(){
	...
	self.navigation = {
		...
		Communities: {
			navNum:0,
			"Community List":{content:"communities/index", setupCallback:self.emptySetup},
			"Search for Communities":{content:"communities/search", setupCallback:self.emptySetup},
			"Create your Community":{content:"communities/create", setupCallback:self.emptySetup}
		},
		ProjectDetails:{
			navNum:2,
